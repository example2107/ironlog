...
const DEFAULT_EXERCISES = [
  ...
  { name: "Грудь", slug: "chest", exercises: [
    seedEx(7,  "Жим штанги лёжа (свободный вес)",       "Горизонтальный"),
    seedEx(8,  "Horizontal Bench Press (тренажёр)",      "Горизонтальный"),
    seedEx(9,  "Жим гантелей на горизонтальной скамье", "Горизонтальный"),
    seedEx(10, "Жим штанги на наклонной скамье",        "Наклонный"),
    seedEx(11, "Жим гантелей на наклонной скамье",      "Наклонный"),
  ]},
  { name: "Спина", slug: "back", exercises: [
    seedEx(12, "Тяга вертикального блока широким хватом", "Ширина"),
    seedEx(13, "Тяга вертикального блока в хаммере",      "Ширина"),
    seedEx(14, "Тяга горизонтального блока к поясу",      "Толщина"),
    seedEx(15, "Тяга т-грифа",                            "Толщина"),
  ]},
